...
try:
    ...
    print(
        "Model doesn't exist "
        + str(e)
        + ", will create a dummy one for the demo. Please install dbdemos.install('lakehouse-retail-c360') to get a real model"
    )
    ...
    model_registered = mlflow.register_model(
        f"runs:/{ mlflow_run.info.run_id }/dummy_model", model_name
    )
...
predict = mlflow.pyfunc.spark_udf(
    spark, f"models:/dbdemos_churn_dbt_model/Production", result_type="double"
)  # , env_manager="conda"
